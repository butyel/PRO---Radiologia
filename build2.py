...
new_html += '<meta name="description" content="Tomografia Cone Beam 3D em Presidente Prudente. Alta resolucao, baixa radiacao. Ideal para implantes, cirurgias e endodontia. Entrega digital DICOM em ate 1 hora.">\n'
new_html += '<meta name="keywords" content="tomografia cone beam presidente prudente, CBCT odontologico, tomografia 3D dental SP">\n'
new_html += '<meta property="og:title" content="Tomografia 3D (CBCT) | PRO Radiologia">\n'
new_html += '<meta property="og:description" content="Tomografia Cone Beam 3D em Presidente Prudente. Alta resolucao, baixa radiacao. Ideal para implantes, cirurgias e endodontia. Entrega digital DICOM em ate 1 hora.">\n'
...
if page_body_end == -1:
    # Try another pattern
    page_body_end = tomo_content.find('<footer>')
...
print('Total length:', len(new_html))
